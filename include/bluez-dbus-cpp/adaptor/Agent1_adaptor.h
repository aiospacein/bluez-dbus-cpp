...
#ifndef __sdbuscpp__include_bluez_dbus_cpp_adaptor_Agent1_adaptor_h__adaptor__H__
#define __sdbuscpp__include_bluez_dbus_cpp_adaptor_Agent1_adaptor_h__adaptor__H__
